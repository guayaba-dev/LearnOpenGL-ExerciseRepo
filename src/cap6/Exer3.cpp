...
// BOTTOM left is not shown because negate values are not croped to zero in GLSL
// and there isn't negative colors if we wanted to show somenthin we would use
// abs function to make those negative values some positives ones
...
int main() {
  ...
  GLFWwindow *window = glfwCreateWindow(800, 600, "CAP6-Exer3", NULL, NULL);
